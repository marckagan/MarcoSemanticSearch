...
See [docs/PROPOSAL.md](docs/PROPOSAL.md) for the full writeup, [server-sample/](server-sample/) for the Mac Mini farm chunk+embed pipeline sketch, and [client-sample/](client-sample/) for the iOS-side storage + query engine sketch.
